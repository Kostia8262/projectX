...
export const STORIES: Record<string, GameStory> = {
  "pilot-a": {
    ...
    variants: {
      ...
      "implement-paddle": "Смена руки на шлёпалку застала её врасплох — ойкнула, но не попросила остановиться.",
    },
    fallback: "Раунд завершён — первое знакомство прошло удачно.",
  },
  "pilot-b": {
    intro:
    ...
    fallback: "Урок дисциплины усвоен — на сегодня достаточно.",
  },
  "pilot-c": {
    intro:
    ...
    fallback: "Короткая, но насыщенная встреча подошла к концу.",
  },
  "pilot-d": {
    intro:
